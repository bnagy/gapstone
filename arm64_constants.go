...
const (
	...
	ARM64_OP_REG     = C.ARM64_OP_REG  // uint operand.
	ARM64_OP_CIMM    = C.ARM64_OP_CIMM // C-Immediate
	ARM64_OP_IMM     = C.ARM64_OP_IMM  // Immediate operand.
	ARM64_OP_FP      = C.ARM64_OP_FP   // Floating-Point immediate operand.
	ARM64_OP_MEM     = C.ARM64_OP_MEM  // Memory operand
)
